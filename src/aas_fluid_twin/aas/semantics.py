...
_VOCABULARY: tuple[Concept, ...] = (
    ...
    Concept(
        ...
        "ControlSignals",
        "Control signals",
        "Measured signals a control rule may switch an actuator on.",
        _D.STRING,
    ),
    Concept(
        "SimulationControl",
        "ControlSignal",
        "Control signal",
        "One entry of the model's measured-signal bus, addressable by a control rule.",
        _D.STRING,
    ),
    Concept(
        "SimulationControl",
        "SignalIndex",
        "Signal index",
        "Position of the signal in the model's bus; what a rule stores.",
        _D.INTEGER_COUNT,
    ),
    Concept(
        "SimulationControl",
        ...
        "Actuators that can be taken off the schedule and put under a control rule.",
        _D.STRING,
    ),
    Concept(
        "SimulationControl",
        "Actuator",
        "Actuator",
        "One actuator of the model, named as the schedule and the rules name it.",
        _D.STRING,
    ),
